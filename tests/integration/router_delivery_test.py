...
def test_endpoint_returns_correct_error_with_all_missing_query_parameters(test_client):
...
def test_endpoint_returns_correct_error_with_missing_query_user_lon_param(test_client):
...
def test_endpoint_returns_correct_error_with_unacceptable_venue_param(test_client):
